...
class FaceDetectorActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new FaceDetectorResult();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type FaceDetectorActionResult
    // Serialize message field [header]
    bufferOffset = std_msgs.msg.Header.serialize(obj.header, buffer, bufferOffset);
    // Serialize message field [status]
    bufferOffset = actionlib_msgs.msg.GoalStatus.serialize(obj.status, buffer, bufferOffset);
    // Serialize message field [result]
    bufferOffset = FaceDetectorResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type FaceDetectorActionResult
    let len;
    let data = new FaceDetectorActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = FaceDetectorResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += FaceDetectorResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FaceDetectorActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = FaceDetectorResult.Resolve(msg.result)
    }
    else {
      resolved.result = new FaceDetectorResult()
    }
...
module.exports = FaceDetectorActionResult;
