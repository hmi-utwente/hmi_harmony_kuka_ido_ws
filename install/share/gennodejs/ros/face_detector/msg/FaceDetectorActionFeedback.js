...
class FaceDetectorActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new FaceDetectorFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type FaceDetectorActionFeedback
    ...
    bufferOffset = FaceDetectorFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type FaceDetectorActionFeedback
    let len;
    let data = new FaceDetectorActionFeedback(null);
    ...
    data.feedback = FaceDetectorFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FaceDetectorActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = FaceDetectorFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new FaceDetectorFeedback()
    }
...
module.exports = FaceDetectorActionFeedback;
