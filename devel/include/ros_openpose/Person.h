...
struct Person_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::ros_openpose::BodyPart_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ros_openpose::BodyPart_<ContainerAllocator> >> _bodyParts_type;
  _bodyParts_type bodyParts;

   typedef std::vector< ::ros_openpose::BodyPart_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ros_openpose::BodyPart_<ContainerAllocator> >> _leftHandParts_type;
  _leftHandParts_type leftHandParts;

   typedef std::vector< ::ros_openpose::BodyPart_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ros_openpose::BodyPart_<ContainerAllocator> >> _rightHandParts_type;
  _rightHandParts_type rightHandParts;

   typedef std::vector< ::ros_openpose::BodyPart_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ros_openpose::BodyPart_<ContainerAllocator> >> _faceParts_type;
  _faceParts_type faceParts;
...
struct MD5Sum< ::ros_openpose::Person_<ContainerAllocator> >
{
  ...
  {
    return "719781611105baee252c1ac007e97ed7";
  }

  static const char* value(const ::ros_openpose::Person_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x719781611105baeeULL;
  static const uint64_t static_value2 = 0x252c1ac007e97ed7ULL;
};
...
struct Printer< ::ros_openpose::Person_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ros_openpose::Person_<ContainerAllocator>& v)
  {
    ...
    s << indent << "faceParts[]" << std::endl;
    for (size_t i = 0; i < v.faceParts.size(); ++i)
    {
      s << indent << "  faceParts[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::ros_openpose::BodyPart_<ContainerAllocator> >::stream(s, indent + "    ", v.faceParts[i]);
    }
  }
};
