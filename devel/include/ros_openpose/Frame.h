...
struct Frame_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::ros_openpose::Person_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ros_openpose::Person_<ContainerAllocator> >> _persons_type;
