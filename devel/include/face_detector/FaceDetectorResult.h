...
struct FaceDetectorResult_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::people_msgs::PositionMeasurement_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::people_msgs::PositionMeasurement_<ContainerAllocator> >> _face_positions_type;
...
bool operator==(const ::face_detector::FaceDetectorResult_<ContainerAllocator1> & lhs, const ::face_detector::FaceDetectorResult_<ContainerAllocator2> & rhs)
{
  return lhs.face_positions == rhs.face_positions;
}
