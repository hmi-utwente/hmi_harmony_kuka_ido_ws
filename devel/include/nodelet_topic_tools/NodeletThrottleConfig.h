  ...
  public:
    ...
    public:
      ParamDescription(std::string a_name, std::string a_type, uint32_t a_level,
          std::string a_description, std::string a_edit_method, T NodeletThrottleConfig::* a_f) :
      ...
      virtual void clamp(NodeletThrottleConfig &config, const NodeletThrottleConfig &max, const NodeletThrottleConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const NodeletThrottleConfig &config1, const NodeletThrottleConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, NodeletThrottleConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const NodeletThrottleConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, NodeletThrottleConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const NodeletThrottleConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const NodeletThrottleConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, NodeletThrottleConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
