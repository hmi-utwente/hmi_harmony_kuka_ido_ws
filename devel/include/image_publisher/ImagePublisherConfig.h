...
namespace image_publisher
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(ImagePublisherConfig &config, const ImagePublisherConfig &max, const ImagePublisherConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const ImagePublisherConfig &config1, const ImagePublisherConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, ImagePublisherConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const ImagePublisherConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, ImagePublisherConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const ImagePublisherConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const ImagePublisherConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, ImagePublisherConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
