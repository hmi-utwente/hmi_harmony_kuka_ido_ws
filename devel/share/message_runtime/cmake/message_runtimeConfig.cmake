...
if("TRUE" STREQUAL "TRUE")
  set(message_runtime_SOURCE_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/message_runtime)
  set(message_runtime_DEVEL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/devel)
  ...
  set(message_runtime_INSTALL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'message_runtime' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/message_runtime/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT message_runtime_NUM_DUMMY_TARGETS)
      set(message_runtime_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::message_runtime::wrapped-linker-option${message_runtime_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR message_runtime_NUM_DUMMY_TARGETS "${message_runtime_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::message_runtime::wrapped-linker-option${message_runtime_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND message_runtime_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(message_runtime_EXPORTED_TARGETS ${${message_runtime_dep}_EXPORTED_TARGETS})
endforeach()
