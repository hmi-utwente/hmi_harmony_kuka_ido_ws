...
if("TRUE" STREQUAL "TRUE")
  set(actionlib_tools_SOURCE_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/actionlib/actionlib_tools)
  set(actionlib_tools_DEVEL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/devel)
  ...
  set(actionlib_tools_INSTALL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'actionlib_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/actionlib/actionlib_tools/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT actionlib_tools_NUM_DUMMY_TARGETS)
      set(actionlib_tools_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::actionlib_tools::wrapped-linker-option${actionlib_tools_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR actionlib_tools_NUM_DUMMY_TARGETS "${actionlib_tools_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::actionlib_tools::wrapped-linker-option${actionlib_tools_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND actionlib_tools_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(actionlib_tools_EXPORTED_TARGETS ${${actionlib_tools_dep}_EXPORTED_TARGETS})
endforeach()
