...
if("TRUE" STREQUAL "TRUE")
  set(pluginlib_SOURCE_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/pluginlib/pluginlib)
  set(pluginlib_DEVEL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/devel)
  ...
  set(pluginlib_INSTALL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/install)
...
if(NOT "/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/pluginlib/pluginlib/include;/usr/include " STREQUAL " ")
  set(pluginlib_INCLUDE_DIRS "")
  set(_include_dirs "/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/pluginlib/pluginlib/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/pluginlib/pluginlib/${idir}'.  ${_report}")
    endif()
    _list_append_unique(pluginlib_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/x86_64-linux-gnu/libboost_filesystem.so.1.74.0;/usr/lib/x86_64-linux-gnu/libtinyxml2.so")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT pluginlib_NUM_DUMMY_TARGETS)
      set(pluginlib_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::pluginlib::wrapped-linker-option${pluginlib_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR pluginlib_NUM_DUMMY_TARGETS "${pluginlib_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::pluginlib::wrapped-linker-option${pluginlib_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND pluginlib_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(pluginlib_EXPORTED_TARGETS ${${pluginlib_dep}_EXPORTED_TARGETS})
endforeach()
