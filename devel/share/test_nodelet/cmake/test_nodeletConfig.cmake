...
if("TRUE" STREQUAL "TRUE")
  set(test_nodelet_SOURCE_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/nodelet_core/test_nodelet)
  set(test_nodelet_DEVEL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/devel)
  ...
  set(test_nodelet_INSTALL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test_nodelet' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/nodelet_core/test_nodelet/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT test_nodelet_NUM_DUMMY_TARGETS)
      set(test_nodelet_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::test_nodelet::wrapped-linker-option${test_nodelet_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR test_nodelet_NUM_DUMMY_TARGETS "${test_nodelet_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::test_nodelet::wrapped-linker-option${test_nodelet_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND test_nodelet_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(test_nodelet_EXPORTED_TARGETS ${${test_nodelet_dep}_EXPORTED_TARGETS})
endforeach()
