...
if("TRUE" STREQUAL "TRUE")
  set(test_diagnostic_aggregator_SOURCE_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/diagnostics/test_diagnostic_aggregator)
  set(test_diagnostic_aggregator_DEVEL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/devel)
  ...
  set(test_diagnostic_aggregator_INSTALL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/install)
...
if(NOT "/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/diagnostics/test_diagnostic_aggregator/include " STREQUAL " ")
  set(test_diagnostic_aggregator_INCLUDE_DIRS "")
  set(_include_dirs "/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/diagnostics/test_diagnostic_aggregator/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test_diagnostic_aggregator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/diagnostics/test_diagnostic_aggregator/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT test_diagnostic_aggregator_NUM_DUMMY_TARGETS)
      set(test_diagnostic_aggregator_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::test_diagnostic_aggregator::wrapped-linker-option${test_diagnostic_aggregator_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR test_diagnostic_aggregator_NUM_DUMMY_TARGETS "${test_diagnostic_aggregator_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::test_diagnostic_aggregator::wrapped-linker-option${test_diagnostic_aggregator_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND test_diagnostic_aggregator_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(test_diagnostic_aggregator_EXPORTED_TARGETS ${${test_diagnostic_aggregator_dep}_EXPORTED_TARGETS})
endforeach()
