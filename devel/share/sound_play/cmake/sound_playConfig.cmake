...
if("TRUE" STREQUAL "TRUE")
  set(sound_play_SOURCE_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/audio_common/sound_play)
  set(sound_play_DEVEL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/devel)
  ...
  set(sound_play_INSTALL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/install)
...
if(NOT "/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/devel/include;/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/audio_common/sound_play/include " STREQUAL " ")
  set(sound_play_INCLUDE_DIRS "")
  set(_include_dirs "/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/devel/include;/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/audio_common/sound_play/include")
  ...
  elseif(NOT "http://ros.org/wiki/sound_play " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/sound_play' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sound_play' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/audio_common/sound_play/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT sound_play_NUM_DUMMY_TARGETS)
      set(sound_play_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::sound_play::wrapped-linker-option${sound_play_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR sound_play_NUM_DUMMY_TARGETS "${sound_play_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::sound_play::wrapped-linker-option${sound_play_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND sound_play_LIBRARIES "${interface_target_name}")
...
set(sound_play_EXPORTED_TARGETS "sound_play_generate_messages_cpp;sound_play_generate_messages_eus;sound_play_generate_messages_lisp;sound_play_generate_messages_nodejs;sound_play_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${sound_play_dep}_FOUND)
      find_package(${sound_play_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${sound_play_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
