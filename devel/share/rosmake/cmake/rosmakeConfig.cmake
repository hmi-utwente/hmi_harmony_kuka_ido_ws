...
if("TRUE" STREQUAL "TRUE")
  set(rosmake_SOURCE_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/ros/tools/rosmake)
  set(rosmake_DEVEL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/devel)
  set(rosmake_INSTALL_PREFIX "")
  set(rosmake_PREFIX ${rosmake_DEVEL_PREFIX})
else()
  set(rosmake_SOURCE_PREFIX "")
  set(rosmake_DEVEL_PREFIX "")
  set(rosmake_INSTALL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/rosmake " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/rosmake' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosmake' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/ros/tools/rosmake/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rosmake_NUM_DUMMY_TARGETS)
      set(rosmake_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rosmake::wrapped-linker-option${rosmake_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rosmake_NUM_DUMMY_TARGETS "${rosmake_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rosmake::wrapped-linker-option${rosmake_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rosmake_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rosmake_EXPORTED_TARGETS ${${rosmake_dep}_EXPORTED_TARGETS})
endforeach()
