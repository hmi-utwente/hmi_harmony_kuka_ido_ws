...
if("TRUE" STREQUAL "TRUE")
  set(self_test_SOURCE_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/diagnostics/self_test)
  set(self_test_DEVEL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/devel)
  ...
  set(self_test_INSTALL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/install)
...
if(NOT "/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/diagnostics/self_test/include " STREQUAL " ")
  set(self_test_INCLUDE_DIRS "")
  set(_include_dirs "/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/diagnostics/self_test/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://www.ros.org/wiki/self_test " STREQUAL " ")
    set(_report "Check the website 'http://www.ros.org/wiki/self_test' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'self_test' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'self_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/diagnostics/self_test/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT self_test_NUM_DUMMY_TARGETS)
      set(self_test_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::self_test::wrapped-linker-option${self_test_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR self_test_NUM_DUMMY_TARGETS "${self_test_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::self_test::wrapped-linker-option${self_test_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND self_test_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${self_test_dep}_FOUND)
      find_package(${self_test_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${self_test_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(self_test_EXPORTED_TARGETS ${${self_test_dep}_EXPORTED_TARGETS})
endforeach()
