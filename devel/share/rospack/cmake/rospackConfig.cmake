...
if("TRUE" STREQUAL "TRUE")
  set(rospack_SOURCE_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/rospack)
  set(rospack_DEVEL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/devel)
  set(rospack_INSTALL_PREFIX "")
  set(rospack_PREFIX ${rospack_DEVEL_PREFIX})
else()
  set(rospack_SOURCE_PREFIX "")
  set(rospack_DEVEL_PREFIX "")
  set(rospack_INSTALL_PREFIX /home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/install)
...
if(NOT "/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/rospack/include;/usr/include " STREQUAL " ")
  set(rospack_INCLUDE_DIRS "")
  set(_include_dirs "/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/rospack/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rospack' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arjan/Desktop/ros_noetic_base_2204/catkin_ws/src/rospack/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rospack_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rospack;/usr/lib/x86_64-linux-gnu/libpython3.10.so;/usr/lib/x86_64-linux-gnu/libboost_filesystem.so.1.74.0;/usr/lib/x86_64-linux-gnu/libboost_program_options.so.1.74.0;/usr/lib/x86_64-linux-gnu/libboost_system.so.1.74.0;/usr/lib/x86_64-linux-gnu/libtinyxml2.so")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rospack_NUM_DUMMY_TARGETS)
      set(rospack_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rospack::wrapped-linker-option${rospack_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rospack_NUM_DUMMY_TARGETS "${rospack_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rospack::wrapped-linker-option${rospack_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rospack_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rospack_EXPORTED_TARGETS ${${rospack_dep}_EXPORTED_TARGETS})
endforeach()
