...
#include <memory>
#include "../../../../../../../../../src/qt_gui_core/qt_gui_cpp/include/qt_gui_cpp/plugin_bridge.h"
...
void qt_gui_cpp::PluginBridge::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PluginBridge *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject qt_gui_cpp::PluginBridge::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_qt_gui_cpp__PluginBridge.data,
    qt_meta_data_qt_gui_cpp__PluginBridge,
    qt_static_metacall,
    nullptr,
    nullptr
} };
