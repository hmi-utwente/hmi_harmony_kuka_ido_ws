...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-ltf2;/usr/lib/x86_64-linux-gnu/libconsole_bridge.so.1.0".split(';') if "-ltf2;/usr/lib/x86_64-linux-gnu/libconsole_bridge.so.1.0" != "" else []
PROJECT_NAME = "tf2"
